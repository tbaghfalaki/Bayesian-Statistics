...
# Assign random sign to get standard normal samples Z
signs <- sample(c(-1, 1), n_samples, replace = TRUE)
Z_samples <- X_samples * signs
...
hist(Y_samples, breaks = 50, probability = TRUE,
     main = "Histogram of Samples from N(μ, σ²) via Rejection Sampling",
...
legend("topright", legend = c("Sample histogram", "True Normal density"),
